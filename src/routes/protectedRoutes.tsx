...
const ProductDetailPage = Loadable(lazy(() => import('../pages/products/ProductDetailPage')));
const TrainersPage = Loadable(lazy(() => import('../pages/trainers/TrainersPage')));
const CategoriesPage = Loadable(lazy(() => import('../pages/categories/CategoriesPage')));
const TransactionsPage = Loadable(lazy(() => import('../pages/transactions/TransactionsPage')));
...
export const protectedRoutes = {
    ...
    children: [
        ...
        { path: 'trainers/requests', element: <div>Trainer Requests Page</div> },
