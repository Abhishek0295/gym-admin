...
const SettingsPage: React.FC = () => {
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState<'email' | 'password' | 'bank'>('email');
              ...
              <form onSubmit={emailForm.handleSubmit(onSubmitEmail)} className="space-y-6">
                <div>
                  ...
                  <div className="space-y-4">
                    <FormField
                      label="Current Email"
                      registration={emailForm.register('currentEmail')}
                      error={emailForm.formState.errors.currentEmail?.message}
                      disabled
                    />
                    <FormField
                      label="New Email Address"
                      type="email"
                      registration={emailForm.register('newEmail')}
                    ...
                    <FormField
                      label="Password"
                      type="password"
                      registration={emailForm.register('password')}
              ...
              <form onSubmit={bankForm.handleSubmit(onSubmitBank)} className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Add or update your bank details for payouts and transactions.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      label="Account Name"
                      registration={bankForm.register('accountName')}
                    ...
                    <FormField
                      label="Bank Name"
                      registration={bankForm.register('bankName')}
                    ...
                    <FormField
                      ...
                      registration={bankForm.register('accountNumber')}
                    ...
                    <FormField
                      ...
                      registration={bankForm.register('routingNumber')}
